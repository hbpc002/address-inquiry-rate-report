...
describe('WorkloadDetail - 详情抽屉自定义列测试', () => {
  ...
  const allMetricFields = [
    ...
    { field: '操作次数及时长-示忙时长(秒)', label: '示忙时长(秒)', isRate: false, width: 80 },
    { field: '操作次数及时长-休息次数', label: '休息次数', isRate: false, width: 80 },
    { field: '操作次数及时长-休息时长(秒)', label: '休息时长(秒)', isRate: false, width: 80 }
  ]
