...
class Schedule(Base):
    ...
    punctuality_rate = Column(DECIMAL(7, 4))
    call_duration = Column(DECIMAL(4, 1))
    organize_duration = Column(DECIMAL(4, 1))
    utilization_rate = Column(DECIMAL(7, 4))
    attendance_rate = Column(DECIMAL(7, 4))
