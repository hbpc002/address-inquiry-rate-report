...
def _seed_field_annotations():
    ...
    seed = [
        ...
        {"report_type": "workload", "field_path": "总体-工时利用率", "field_label": "工时利用率",
         "source": "工作量模块(workloads)的派生指标，系统按公式重算",
         "formula": "(Σ呼入人工服务通话总时长 + Σ呼入人工服务服务后整理总时长) / Σ总体工作总时长",
         "description": "反映工作时间利用效率，值为0~1比率，前端×100显示为百分比"},
        ...
        {"report_type": "workload", "field_path": "操作次数及时长-示忙时长(秒)", "field_label": "示忙时长(秒)",
         "source": "工作量模块(workloads)的原始指标",
         "description": "员工处于示忙状态的累计时长，单位为秒"},
        {"report_type": "workload", "field_path": "操作次数及时长-休息次数", "field_label": "休息次数",
         "source": "工作量模块(workloads)的原始指标",
         "description": "员工进入休息状态的次数"},
        ...
        {"report_type": "checkin", "field_path": "avg_punctuality_rate", "field_label": "遵时率",
         "source": "系统自动计算",
         "formula": "Σ实际工时 / Σ排班工时 × 100%",
         "description": "实际工时取考勤日报 actual_hours(排班段重叠工时)，排班工时取 scheduled_hours 求和"},
        ...
        {"report_type": "checkin", "field_path": "avg_utilization_rate", "field_label": "工时利用率",
         "source": "系统自动计算",
         "formula": "(Σ通话时长 + Σ整理时长) / Σ实际工时 × 100%",
         "description": "实际工时取考勤日报 actual_hours"},
        ...
        {"report_type": "checkin", "field_path": "summary_total_scheduled_hours", "field_label": "排班总工时",
         "source": "排班表(schedules)月度汇总",
         "formula": "∑(当月每日排班工时)", "description": "单位为小时，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_total_hours", "field_label": "累计工时",
         "source": "签到记录(checkins)月度汇总",
         "formula": "∑(当日签退时间 - 签到时间)", "description": "单位为小时，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_team_avg_hours", "field_label": "班组平均工时",
         "source": "按班组对所有员工的累计工时取平均值",
         "description": "单位为小时，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_attend_days", "field_label": "出勤天数",
         "source": "考勤日报表统计", "description": "单位为天，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_scheduled_days", "field_label": "排班天数",
         "source": "排班表统计", "description": "单位为天，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_late_days", "field_label": "晚签天数",
         "source": "考勤日报表统计", "formula": "当月状态为迟到的天数",
         "description": "单位为天，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_early_days", "field_label": "提前签出天数",
         "source": "考勤日报表统计", "formula": "当月状态为早退的天数",
         "description": "单位为天，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_total_call_duration", "field_label": "通话总时长",
         "source": "排班导入数据中的扩展指标月度汇总",
         "description": "单位为小时，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_total_organize_duration", "field_label": "整理总时长",
         "source": "排班导入数据中的扩展指标月度汇总",
         "description": "单位为小时，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_total_training_minutes", "field_label": "培训总时长",
         "source": "培训记录统计", "description": "单位为分钟，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_morning_shift_days", "field_label": "早班天数",
         "source": "排班表统计", "description": "单位为天，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_mid_shift_days", "field_label": "中班天数",
         "source": "排班表统计", "description": "单位为天，来自个人多维统计"},
        {"report_type": "checkin", "field_path": "summary_night_shift_days", "field_label": "晚班天数",
         "source": "排班表统计", "description": "单位为天，来自个人多维统计"},

        {"report_type": "checkin_detail", "field_path": "date", "field_label": "日期",
         "source": "签到记录日期", "description": "个人每日详细签到数据"},
        {"report_type": "checkin_detail", "field_path": "scheduled_hours", "field_label": "排班工时",
         "source": "排班表(schedules)", "description": "单位为小时，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "punctuality_rate", "field_label": "遵时率",
         "source": "系统自动计算",
         "formula": "当日实际工时 / 当日排班工时 × 100%", "description": "个人每日详情，实际工时取考勤日报 actual_hours"},
        {"report_type": "checkin_detail", "field_path": "call_duration", "field_label": "通话时长",
         "source": "排班导入数据", "description": "单位为小时，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "organize_duration", "field_label": "整理时长",
         "source": "排班导入数据", "description": "单位为小时，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "utilization_rate", "field_label": "工时利用率",
         "source": "系统自动计算",
         "formula": "(通话时长 + 整理时长) / 当日实际工时 × 100%", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "attendance_rate", "field_label": "班表出勤率",
         "source": "系统自动计算",
         "formula": "当日有签到且排班则 100%，否则无值", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "training_minutes", "field_label": "培训(分)",
         "source": "排班导入数据", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "computed_punctuality_rate", "field_label": "系统遵时率",
         "source": "系统根据签到记录计算",
         "formula": "按时签到天数 / 总排班天数 × 100%", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "checkin_time", "field_label": "签到时间",
         "source": "签到记录(checkins)", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "checkout_time", "field_label": "签退时间",
         "source": "签到记录(checkins)", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "duration", "field_label": "签入工时",
         "source": "签到记录计算", "formula": "签退时间 - 签到时间",
         "description": "单位为小时，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "status", "field_label": "状态",
         "source": "考勤计算逻辑判定",
         "formula": "正常/迟到/早退/缺勤/请假/休息", "description": "个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "late_minutes", "field_label": "晚签",
         "source": "签到时间 vs 排班开始时间",
         "formula": "max(0, 实际签到时间 - 排班开始时间)", "description": "单位为分钟，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "early_minutes", "field_label": "提前签出",
         "source": "签退时间 vs 排班结束时间",
         "formula": "max(0, 排班结束时间 - 实际签退时间)", "description": "单位为分钟，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "shift_name", "field_label": "班次",
         "source": "排班表班次类型", "description": "早班/中班/晚班，个人每日详情"},
        {"report_type": "checkin_detail", "field_path": "is_long_hour", "field_label": "超长",
         "source": "与工时阈值对比判定",
         "formula": "daily.duration > threshold（阈值在工时预警设置中配置）",
         "description": "个人每日详情"},

        {"report_type": "checkin_detail", "field_path": "summary_total_scheduled_hours", "field_label": "排班总工时",
         "source": "个人详情汇总统计",
         "formula": "∑(每日排班工时scheduled_hours)（仅含出勤日期）",
         "description": "排班总工时"},
        {"report_type": "checkin_detail", "field_path": "summary_total_hours", "field_label": "累计工时",
         "source": "个人详情汇总统计",
         "formula": "∑(duration)，仅统计出勤日的签入工时",
         "description": "累计工时"},
        {"report_type": "checkin_detail", "field_path": "summary_team_avg_hours", "field_label": "班组平均工时",
         "source": "班组签到明细汇总",
         "formula": "班组内全员总工时 / 班组人数",
         "description": "班组平均工时"},
        {"report_type": "checkin_detail", "field_path": "summary_attend_days", "field_label": "出勤天数",
         "source": "个人详情筛选汇总",
         "formula": "count(status IN ('正常','迟到','早退'))",
         "description": "出勤/排班"},
        {"report_type": "checkin_detail", "field_path": "summary_scheduled_days", "field_label": "排班天数",
         "source": "排班表统计", "description": "出勤/排班"},
        {"report_type": "checkin_detail", "field_path": "summary_long_hour_days", "field_label": "超长工时天数",
         "source": "个人详情汇总统计",
         "formula": "count(daily.duration > threshold)",
         "description": "超长工时天数"},
        {"report_type": "checkin_detail", "field_path": "summary_late_days", "field_label": "晚签天数",
         "source": "个人详情筛选计数",
         "formula": "count(late_minutes > 0)",
         "description": "晚签天数"},
        {"report_type": "checkin_detail", "field_path": "summary_early_days", "field_label": "提前签出天数",
         "source": "个人详情筛选计数",
         "formula": "count(early_minutes > 0)",
         "description": "提前签出天数"},
        {"report_type": "checkin_detail", "field_path": "summary_total_call_duration", "field_label": "通话总时长",
         "source": "个人详情汇总",
         "formula": "∑(每日call_duration)",
         "description": "通话总时长"},
        {"report_type": "checkin_detail", "field_path": "summary_total_organize_duration", "field_label": "整理总时长",
         "source": "个人详情汇总",
         "formula": "∑(每日organize_duration)",
         "description": "整理总时长"},
        {"report_type": "checkin_detail", "field_path": "summary_total_training_minutes", "field_label": "培训总时长",
         "source": "个人详情汇总",
         "formula": "∑(每日training_minutes)",
         "description": "培训总时长（分钟）"},
